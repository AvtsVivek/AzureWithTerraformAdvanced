...
sudo echo "Welcome to Step By Step Tutes - AppVM App1 - VM Hostname: $(hostname)" > /var/www/html/index.html
sudo echo "Welcome to Step By Step Tutes - AppVM App1 - VM Hostname: $(hostname)" > /var/www/html/appvm/hostname.html
sudo echo "Welcome to Step By Step Tutes - AppVM App1 - App Status Page" > /var/www/html/appvm/status.html
