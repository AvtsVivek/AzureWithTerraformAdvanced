# Bastion host and Bastion service, both are not needed. So commenting htis out.
# Bastion host is there in tf8-02-bastion-host-linuxvm.tf
# If you want, you can enable this as well.
# ----------------------------------------------------------------------------------------------------
